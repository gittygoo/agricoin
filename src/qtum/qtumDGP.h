#ifndef AGRICOINDGP_H
#define AGRICOINDGP_H
...
public:
    ...
    AgricoinDGP(AgricoinState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataEIP158(); }
