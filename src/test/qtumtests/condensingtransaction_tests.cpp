...
BOOST_AUTO_TEST_CASE(condensingtransactionbehavior_tests){
    ...
    for(size_t i = 0; i < 3; i++){
        txs.push_back(createAgricoinTransaction(code[i], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), i));
        addresses.push_back(createAgricoinAddress(hashTemp, i));
        ++hashTemp;
    }
    ...
    txs.clear();
    for(size_t i = 0; i < 3; i++){
        txs.push_back(createAgricoinTransaction(code[i + 3], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[i]));
    }
    ...
    txs.clear();
    txs.push_back(createAgricoinTransaction(code[6], 8000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
    ...
    txs.clear();
    txs.push_back(createAgricoinTransaction(code[7], 2000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    txs.push_back(createAgricoinTransaction(code[8], 2000, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
    ...
    txs.clear();
    txs.push_back(createAgricoinTransaction(code[6], 2000, dev::u256(30000), dev::u256(1), hashTemp, addresses[1]));
    txs.push_back(createAgricoinTransaction(code[9], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[1]));
    result = executeBC(txs);
    balances = {0,0,0};
    checkRes(result.second, addresses, balances, 2);
...
BOOST_AUTO_TEST_CASE(condensingtransactionbreadthways_tests){
    ...
    txs.push_back(createAgricoinTransaction(code[10], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 4));
    addresses.push_back(createAgricoinAddress(hashTemp, 4));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createAgricoinTransaction(code[0], 15000, dev::u256(500000), dev::u256(1), hashTemp, addresses[3]));
    txs.push_back(createAgricoinTransaction(code[11], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[3]));
...
BOOST_AUTO_TEST_CASE(condensingtransactiondeep_tests){
    ...
    auto result = executeBC(txs);
    txs.clear();
    txs.push_back(createAgricoinTransaction(code[11], 20000, dev::u256(500000), dev::u256(1), hashTemp, addresses[4]));
    result = executeBC(txs);
...
BOOST_AUTO_TEST_CASE(condensingtransactionsuicide_tests){
    ...
    std::vector<dev::Address> addresses;
    std::vector<AgricoinTransaction> txs;
    txs.push_back(createAgricoinTransaction(code[12], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 0));
    addresses.push_back(createAgricoinAddress(hashTemp, 0));
    
    txs.push_back(createAgricoinTransaction(code[17], 0, dev::u256(500000), dev::u256(1), ++hashTemp, dev::Address(), 1));
    txs.push_back(createAgricoinTransaction(valtype(), 13000, dev::u256(500000), dev::u256(1), hashTemp, createAgricoinAddress(hashTemp, 1), 1));

    addresses.push_back(createAgricoinAddress(hashTemp, 1));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createAgricoinTransaction(code[18], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[1]));
    result = executeBC(txs);
...
BOOST_AUTO_TEST_CASE(condensingtransactionpaytopubkeyhash_tests){
    ...
    txs.push_back(createAgricoinTransaction(code[19], 0, dev::u256(500000), dev::u256(1), hashTemp, dev::Address(), 13));
    txs.push_back(createAgricoinTransaction(valtype(), 13000, dev::u256(500000), dev::u256(1), hashTemp, createAgricoinAddress(hashTemp, 13), 13));

    addresses.push_back(createAgricoinAddress(hashTemp, 13));
    auto result = executeBC(txs);

    txs.clear();
    txs.push_back(createAgricoinTransaction(code[11], 0, dev::u256(500000), dev::u256(1), hashTemp, addresses[0]));
    result = executeBC(txs);
