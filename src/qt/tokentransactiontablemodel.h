#ifndef AGRICOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
#define AGRICOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
...
#endif // AGRICOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
