...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // agricoin
        hashUTXORoot.SetNull(); // agricoin
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //agricoin
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //agricoin
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //agricoin
    {
